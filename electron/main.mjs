...
function positionPet(){if(!pet||pet.isDestroyed())return;const {x,y,width,height}=screen.getPrimaryDisplay().bounds;pet.setBounds({x:Math.round(x+width/2-150),y,width:620,height});}
